  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=modern%20automotive%20manufacturing%20facility%20contact%20office%20with%20professional%20reception%20area%2C%20industrial%20workspace%20with%20red%20equipment%20and%20machinery%2C%20business%20meeting%20room%20with%20technical%20drawings%20and%20engineering%20blueprints%2C%20professional%20corporate%20environment%20with%20sophisticated%20lighting%20and%20clean%20design&width=1920&height=1080&seq=contact-hero-bg&orientation=landscape')`,
      ...
      <div className="absolute inset-0">
        ...
        >
          <div className="relative w-full h-full">
            {/* Central Hub */}
            <div className="absolute top-1/2 left-1/2 w-2 h-2 md:w-4 md:h-4 bg-red-500 rounded-full transform -translate-x-1/2 -translate-y-1/2 animate-pulse" />
            
            {/* Connection Lines */}
            {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => (
              <div
                key={angle}
                className="absolute top-1/2 left-1/2 w-16 md:w-32 h-px bg-gradient-to-r from-red-500/50 to-transparent origin-left"
                style={{
            ...
            {[0, 72, 144, 216, 288].map((angle) => (
              <div
                key={angle}
                className="absolute w-1 h-1 md:w-2 md:h-2 bg-red-500/70 rounded-full animate-pulse"
                style={{
                  top: '50%',
                  left: '50%',
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-4 md:px-8">
        <div className="text-center max-w-5xl">
          ...
          >
            ...
            <span className="block font-sans">ile</span>
            <span className="block font-serif italic text-red-500">İletişim</span>
          </h1>
          ...
          >
            Tarım makinası şanzıman ihtiyaçlarınız için bizimle iletişime geçin.<br />
            <span className="text-red-500 font-serif italic">Uzman ekibimiz size yardımcı olmaya hazır.</span>
          </p>
          ...
          >
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 w-full justify-center items-center">
              ...
              >
                <span className="group-hover:tracking-widest transition-all duration-300">İLETİŞİME GEÇİN</span>
              </button>
              
              <button 
                onClick={() => scrollToSection('location-map')}
                className="group px-6 sm:px-8 py-3 border border-red-500 text-red-500 font-bold text-base sm:text-lg tracking-wider hover:bg-red-500 hover:text-white transition-all duration-500 rounded-none whitespace-nowrap cursor-pointer"
              >
                <span className="group-hover:tracking-widest transition-all duration-300">ADRESİMİZ</span>
              </button>
            </div>
