        ...
        <div className="text-center mt-12 md:mt-16">
          <div className="flex flex-col items-center space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 w-full">
              ...
              <Link href="/contact">
                <button className="group px-6 sm:px-8 py-3 border border-amber-400 text-amber-400 font-bold text-base sm:text-lg tracking-wider hover:bg-amber-400 hover:text-black transition-all duration-500 rounded-none whitespace-nowrap cursor-pointer">
